...
- **svm.py**: Run this script to conduct permutation tests using the SVM model. Example: `python svm.py mouse heart`

- **mlp.py**: Run this script to conduct permutation tests using the MLP model. Example: `python mlp.py mouse heart`
