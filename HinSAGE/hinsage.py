# To ensure the reproducibility of the results, we made some improvements to the HinSAGE source code. 
# You need to replace the file at your_environment_path\Lib\site-packages\stellargraph\layer\hinsage.py with the provided one.
...
class MeanHinAggregator(HinSAGEAggregator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Here, we changed the initialization method of the weight matrices.
